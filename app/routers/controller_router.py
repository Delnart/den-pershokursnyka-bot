...
WELCOME_TEXT = (
    "👋 <b>Вітаю!</b> Я бот для реєстрації на <b>День Першокурсника</b>.\n\n"
    "Це масштабний захід, який об'єднає першокурсників та студентів усіх факультетів КПІ!\n"
    "🎵 DJ-сети · 🏆 Благодійний аукціон · 🎉 Активності та знайомства\n\n"
    f"{EVENT_INFO}"
)
