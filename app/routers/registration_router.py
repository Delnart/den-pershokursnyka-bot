...
FACULTIES_KPI = [
    "НН ВПІ", "НН ІАТ", "НН ІАТЕ", "НН ІЕЕ", "НН ІМЗ", "НН ІПСА", 
    "НН ІТС", "НН ММІ", "НН ФТІ", "ІСЗЗІ", "РТФ", "ФАПІЕ", "ФБМІ", 
    "ФБТ", "ФЕА", "ФЕЛ", "ФІОТ", "ФЛ", "ФММ", "ФМФ", 
    "ФПСПМ", "ФРП", "ФСП", "ХТФ"
]
...
RULES_TEXT = (
    ...
    "5) Не палити та не використовувати електронні сигарети у місцях скупчення людей, біля сцени та зон активностей\n"
    "6) Смітити\n"
    ...
    try:
        ...
        await callback.message.edit_text(
            text=(
                ...
                "Слідкуйте за оновленнями та актуальною інформацією про захід на каналах "
                "<a href='https://t.me/fice_time'>FICE Time 🇺🇦</a> та <a href='https://t.me/dsr_kpi'>ДСР (ex ДНВР) 🇺🇦</a>\n\n"
